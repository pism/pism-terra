...
def process_file(
    ...
    # Put time first and swap the string RGI IDs for an integer index, so CDO
    # can open the result at all. See ``make_cdo_readable``.
    scalar = make_cdo_readable(scalar, "RGIid")
